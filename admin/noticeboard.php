...
$noticeTitle = $noticePdf = $msg = $category = "";
$noticePdfError = $imgError = $noticeTitleError = $categoryError = "";
...
if (isset($_POST["submit"])) {
    ...
    if (!empty($noticeTitle) && !empty($u_noticePdf) && !empty($category)) {
        ...
        if ($conn->connect_errno) {
            ...
            $sql = "INSERT INTO notice(notice_title, notice_pdf, category)VALUES('$noticeTitle', '$u_noticePdf','$category')";
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="new-added-form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Category <span class="error">* <?php echo $categoryError ?></span></label>
                                            <select class="select2" name="category">
                                                <option value="">Please Select Category *</option>
                                                <option value="all" <?php if ($category === 'all') {
                                                                        echo "selected";
                                                                    } ?>>Notice for Everyone</option>
                                                <option value="first" <?php if ($category === "first") {
                                                                            echo "selected";
                                                                        } ?>>First Year</option>
                                                <option value="second" <?php if ($category === "second") {
                                                                            echo "selected";
                                                                        } ?>>Second Year</option>
                                                <option value="third" <?php if ($category === 'third') {
                                                                            echo "selected";
                                                                        } ?>>Third Year</option>
                                                <option value="fourth" <?php if ($category === 'fourth') {
                                                                            echo "selected";
                                                                        } ?>>Fourth Year</option>
                                                <option value="ms" <?php if ($category === 'ms') {
                                                                        echo "selected";
                                                                    } ?>>MS</option>
                                                <option value="phd" <?php if ($category === 'phd') {
                                                                        echo "selected";
                                                                    } ?>>PhD</option>
                                            </select>
                                        </div>
