...
if (isset($_POST["submit"])) {
    ...
    if (!empty($firstname) && !empty($lastname) && !empty($gender) && !empty($birthdate) && !empty($roll) && !empty($bloodgroup) && !empty($religion) && !empty($email) && !empty($session) && !empty($registrationid) && !empty($phone)  && !empty($year) && !empty($u_profileimage)) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" name="year">
                                        ...
                                        <option value="first" <?php if ($year === "first") {
                                                                    echo "selected";
                                                                } ?>>First Year</option>
                                        <option value="second" <?php if ($year === "second") {
                                                                    echo "selected";
                                                                } ?>>Second Year</option>
                                        <option value="third" <?php if ($year === 'third') {
                                                                    echo "selected";
                                                                } ?>>Third Year</option>
                                        <option value="fourth" <?php if ($year === 'fourth') {
                                                                    echo "selected";
                                                                } ?>>Fourth Year</option>
                                        <option value="ms" <?php if ($year === 'ms') {
                                                                echo "selected";
                                                            } ?>>MS</option>
                                        <option value="phd" <?php if ($year === 'phd') {
                                                                echo "selected";
                                                            } ?>>PhD</option>
                                    </select>
                                </div>
